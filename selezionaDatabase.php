<!-- Page that allows teachers to select a database to be able to proceed with the population -->
<?php
  session_start();
              ...
              echo "<div class='col-md-auto card mt-5 ml-3 mr-3' style='width: 18rem;'>
                    <img class='card-img-top mt-3' src='img/" . $riga['Immagine'] .  "' alt='Card image cap'>
                      <div class='card-body'>
                        ...
                        <form action='popolaDatabaseCodice.php' method='post'>
                          <input type='hidden' name='nomeDatabaseSelezionato' value='" . $riga['NomeDatabase'] . "'>
                          <center><button type='submit' name='selezionaDomandaButton' class='btn btn-primary'> Popola tramite codice </button></center>
                        </form>

                        <form action='popolaDatabaseFile.php' method='post'>
                          <input type='hidden' name='nomeDatabaseSelezionato' value='" . $riga['NomeDatabase'] . "'>
                          <center><button type='submit' name='selezionaDomandaButton' class='btn btn-primary'> Popola tramite file </button></center>
                        </form>
                      </div>
                    </div>";
            }
